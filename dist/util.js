...
var writeFile = function (ROOT, data) {
    if (ROOT === void 0) { ROOT = process.cwd(); }
    var dataJSON = JSON.stringify(data);
    fs_1.promises.writeFile(path.join(ROOT, 'DATA.json'), dataJSON);
};
exports.writeFile = writeFile;
var getData = function (ctx, encrypt, tagName) { return __awaiter(void 0, void 0, void 0, function () {
    var bodyXML, result, match;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getPostData(ctx)];
            case 1:
                bodyXML = _a.sent();
                result = '';
                match = null;
